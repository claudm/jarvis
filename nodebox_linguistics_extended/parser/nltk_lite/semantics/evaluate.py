...
class CharFun(dict):
    ...
    def tuples(self):
        ...
        if n == 1:
            ...
            tuples = [(k2, k1) for k1 in list(self.keys()) for k2 in list(self[k1].keys())]
        elif n == 3:
            tuples = [(k3, k2, k1) for k1 in list(self.keys()) for k2 in list(self[k1].keys()) for k3 in list(self[k1][k2].keys())]
        else:
